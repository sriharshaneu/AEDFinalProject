...
//Order order = new Order();
	...
	public BillForm(HashMap<String, Integer> tempOrderList, Voucher voucher, String s) {
		...
		tempOrderList.keySet().forEach((String foodItem)
			-> {
			if (!tempOrderList.containsKey(foodItem)) {
		...
		txtArea_bill.append("\n            Thank you for visiting Khake Jao\n");
		txtArea_bill.append("\n*******************************************\n");
	}
                                ...
                                .addGroup(pnl_rateLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnl_rateLayout.createSequentialGroup()
                                                ...
                                                .addGroup(pnl_rateLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                        ...
                                                        .addComponent(lbl_complain, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 342, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//	    }
    ...
    private void btn_orderStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_orderStatusActionPerformed
	    // TODO add your handling code here:
	    if (checkStatusInChefOrders(Integer.parseInt(OrderForm.currentOrder.getId()))) {
	    ...
	    } else if (User.orderType == null) {
		    JOptionPane.showMessageDialog(this, "orderType null on line 42 ==> BillForm.java", null, JOptionPane.OK_OPTION);
	    } else {
